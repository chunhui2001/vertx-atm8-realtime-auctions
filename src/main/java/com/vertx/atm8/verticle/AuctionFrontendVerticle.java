...
import com.vertx.atm8.handler.FormLoginWithTokenHandler;
import com.vertx.atm8.handler.ProxyHandler;
...
public class AuctionFrontendVerticle  extends AbstractVerticle {
  ...
  public void start() {
    ...
    ShiroAuthOptions shiroAuthOptions = new ShiroAuthOptions().setType(
      ShiroAuthRealmType.PROPERTIES).setConfig(
        new JsonObject().put("properties_path", "classpath:vertx-users.properties"));
